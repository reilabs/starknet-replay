...
mod tests {
    ...
    fn test_extract_libfuncs_weight() {
        ...
        let sierra_program_json_file = "/test_data/sierra_add.json";
        ...
        let concrete_libfunc_weights =
            internal_extract_libfuncs_weight(&sierra_profiler, &sierra_program, &visited_pcs)
                .unwrap()
                .unwrap();
        // The result is `store_temp<felt252> 2`
        // const_as_immediate and felt252_add are missing. I don't know why.
